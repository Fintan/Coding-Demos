...
//https://raw.github.com/BenHall/kata_roman_numerals_javascript/master/src/app.js
//https://github.com/pipt/roman-numerals/blob/master/roman.js

define('utils/romanNumerals',['require'],function(require) {
    ...
    var converter = {
        ...
        decimalToRomanNumeral: function(decimalVal) {
            return RomanNumerals.toNumeral(decimalVal);
        },

        romanNumeralToDecimal: function(numeralVal) {
			return RomanNumerals.toDecimal(numeralVal);
        },

		base5RomanNumeral: function(numeralVal) {
			return RomanNumerals.toNumeral(RomanNumerals.toDecimal(numeralVal));
        }
...
define('models/calculator',['require','backbone','utils/romanNumerals'],function(require) {

	var Backbone = require("backbone");
	var converter = require("utils/romanNumerals");
	...
	var CalculatorModel = Backbone.Model.extend({
		...
		updateInput: function(input) {
			...
			if (this.get("lastToken") === "=" && this.isIntegerInput(input)) {
				...
				this.set({
					valueEndAStr: this.get("romanNumeralAnswer")
				});
				this.set({
					valueEndBStr: ""
				});
			...
			if (this.isOperator(input)) {
				...
				if (this.get("operatorIsActivated") === false) {
					...
					this.set({
						valueEndAStr: this.get("valueEndAStr") + input
					});

					if (this.isRomanNumeral(this.get("valueEndAStr"))) {

						this.set({
							valueEndAStr: converter.base5RomanNumeral(this.get("valueEndAStr"))
						});
					...
					this.set({
						valueEndBStr: this.get("valueEndBStr") + input
					});

					if (this.isRomanNumeral(this.get("valueEndBStr"))) {

						this.set({
							valueEndBStr: converter.base5RomanNumeral(this.get("valueEndBStr"))
						});
		...
		assembleDisplayString: function() {
			...
			this.set({
				displayStr: this.get("valueEndAStr") + this.get("currentOperator") + this.get("valueEndBStr") + equalsStr + this.get("romanNumeralAnswer")
			});
		...
		performCalculation: function() {
			...
			this.set({
				romanNumeralAnswer: converter.decimalToRomanNumeral(decimalAnswer)
			}); //Google's search engine calculator does this
			this.set({
				operatorIsActivated: false
			});
			...
			if (this.get("romanNumeralAnswer") === "N") {
				this.set({
					romanNumeralAnswer: this.get("decimalAnswer")
				});
...
define('views/calculatorControls',["backbone"], 
function(Backbone) {
...
define('views/calculatorOutput',["backbone"], 
function(Backbone) {
...
define('views/app',["underscore", "backbone", "models/calculator", "views/calculatorControls", "views/calculatorOutput"], 
