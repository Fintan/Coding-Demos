...
if(!demos.helloeaseljs) demos.helloeaseljs = {}
demos.helloeaseljs.BarGraph = function(p) {
	if( p === $_ ) return;
	this.init();
}
demos.helloeaseljs.BarGraph.__name__ = ["demos","helloeaseljs","BarGraph"];
demos.helloeaseljs.BarGraph.main = function() {
	new demos.helloeaseljs.BarGraph();
}
demos.helloeaseljs.BarGraph.prototype.canvas = null;
demos.helloeaseljs.BarGraph.prototype.stage = null;
demos.helloeaseljs.BarGraph.prototype.barPadding = null;
demos.helloeaseljs.BarGraph.prototype.barHeight = null;
demos.helloeaseljs.BarGraph.prototype.maxValue = null;
demos.helloeaseljs.BarGraph.prototype.count = null;
demos.helloeaseljs.BarGraph.prototype.barValues = null;
demos.helloeaseljs.BarGraph.prototype.bars = null;
demos.helloeaseljs.BarGraph.prototype.init = function() {
	this.barPadding = 7.;
	this.barHeight = 0.;
	this.maxValue = 50.;
	this.count = 0;
...
demos.helloeaseljs.BarGraph.prototype.tick = function() {
...
demos.helloeaseljs.BarGraph.prototype.drawBar = function(bar,value,index) {
...
demos.helloeaseljs.BarGraph.prototype.getHueForBarIndex = function(i,numBars) {
	return Std["int"](i / numBars * 360);
}
demos.helloeaseljs.BarGraph.prototype.__class__ = demos.helloeaseljs.BarGraph;
$_ = {}
js.Boot.__res = {}
js.Boot.__init();
{
...
js.Lib.onerror = null;
demos.helloeaseljs.BarGraph.main()