...
demos.easel.BarGraphTest = function(p) {
	if( p === $_ ) return;
	this.init();
}
demos.easel.BarGraphTest.__name__ = ["demos","easel","BarGraphTest"];
demos.easel.BarGraphTest.main = function() {
	new demos.easel.BarGraphTest();
}
demos.easel.BarGraphTest.prototype.canvas = null;
demos.easel.BarGraphTest.prototype.stage = null;
demos.easel.BarGraphTest.prototype.barPadding = null;
demos.easel.BarGraphTest.prototype.barHeight = null;
demos.easel.BarGraphTest.prototype.maxValue = null;
demos.easel.BarGraphTest.prototype.count = null;
demos.easel.BarGraphTest.prototype.barValues = null;
demos.easel.BarGraphTest.prototype.bars = null;
demos.easel.BarGraphTest.prototype.init = function() {
	this.barPadding = 7.;
	this.barHeight = 0.;
	this.maxValue = 50.;
	this.count = 0;
	...
	haxe.Log.trace("canvas " + this.canvas,{ fileName : "BarGraphTest.hx", lineNumber : 39, className : "demos.easel.BarGraphTest", methodName : "init"});
	...
	while(_g < numBars) {
		...
		var front = new Shape();
		var colors = [Graphics.getHSL(hue,100,60,0.9),Graphics.getHSL(hue,100,20,0.75)];
		front.graphics.beginLinearGradientFill(colors,[0.,1.],0,-100,barWidth,0).drawRect(0,-100,barWidth,100);
		var top = new Shape();
		...
		barDom.onPress = (function(i) {
			return function(e) {
				haxe.Log.trace("onPress: " + i[0],{ fileName : "BarGraphTest.hx", lineNumber : 161, className : "demos.easel.BarGraphTest", methodName : "init"});
			};
		})(i);
...
demos.easel.BarGraphTest.prototype.tick = function() {
...
demos.easel.BarGraphTest.prototype.drawBar = function(bar,value,index) {
...
demos.easel.BarGraphTest.prototype.getHueForBarIndex = function(i,numBars) {
	return Std["int"](i / numBars * 360);
}
demos.easel.BarGraphTest.prototype.__class__ = demos.easel.BarGraphTest;
$_ = {}
js.Boot.__res = {}
js.Boot.__init();
{
