...
demos.easel.GlobalToLocal3Test = function() {
	this.init();
};
demos.easel.GlobalToLocal3Test.__name__ = true;
demos.easel.GlobalToLocal3Test.main = function() {
	new demos.easel.GlobalToLocal3Test();
}
demos.easel.GlobalToLocal3Test.prototype = {
	handleButtonClick: function(event) {
		this.setupBallValue();
	}
	,setupBallValue: function() {
	...
	,__class__: demos.easel.GlobalToLocal3Test
}
var js = js || {}
js.Boot = function() { }
