...
var demos = {}
demos.easel = {}
demos.easel.BarGraphTest = function() {
	this.init();
};
demos.easel.BarGraphTest.__name__ = true;
demos.easel.BarGraphTest.main = function() {
	new demos.easel.BarGraphTest();
}
demos.easel.BarGraphTest.prototype = {
	getHueForBarIndex: function(i,numBars) {
		return i / numBars * 360 | 0;
	}
	,drawBar: function(bar,value,index) {
	...
	,init: function() {
		...
		console.log("canvas " + Std.string(this.canvas));
	...
	,__class__: demos.easel.BarGraphTest
}
var js = {}
js.Boot = function() { }
